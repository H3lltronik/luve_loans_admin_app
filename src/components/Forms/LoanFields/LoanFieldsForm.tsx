...
export type LoanFieldFormHandle = {
  getFormData: (params?: GetFormData) => Promise<LoanField>;
};

type LoanFieldFormProps = {
  entity?: LoanField | null;
};

const LoanFieldForm = forwardRef<LoanFieldFormHandle, LoanFieldFormProps>(
  (props, ref) => {
