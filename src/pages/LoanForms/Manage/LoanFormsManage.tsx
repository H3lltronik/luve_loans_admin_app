...
export const LoanFormsManage: React.FC = () => {
  ...
  const { mutateAsync } = useMutation((data: CreateLoanFormRequest) =>
    LoanFormAPI.createLoanForm(data)
  );
  ...
  const submitForm = async (isDraft = false) => {
    const loanFormFormData = (await loanFormFormRef.current?.getFormData({
      draftMode: isDraft,
    })) as CreateLoanFormRequest;
    ...
    try {
      ...
      if (entity?.data) {
        ...
        result = await mutateAsync(loanFormFormData);
